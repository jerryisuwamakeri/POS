...
<div class="min-h-screen animate-fade-in">
    <div class="p-8 max-w-4xl mx-auto">
        <div class="mb-10">
            <h1 class="text-2xl sm:text-3xl font-bold text-gradient mb-4 tracking-tight">Edit Customer</h1>
            <a href="{{ route('customers.index') }}" class="text-blue-600 hover:text-blue-700 font-semibold hover:underline text-lg">← Back</a>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="2"
                                  class="input-modern w-full @error('address') border-red-500 @enderror">{{ old('address', $customer->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="3"
                                  class="input-modern w-full @error('notes') border-red-500 @enderror">{{ old('notes', $customer->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
