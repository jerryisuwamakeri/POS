...
<head>
    ...
    <title><?php echo e(config('app.name', 'Cutietyha POS')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
           ...
           ?>
           <?php if($logoExists): ?>
               <link rel="icon" type="image/png" href="<?php echo e(asset('build/assets/logo.png')); ?>">
               <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('build/assets/logo.png')); ?>">
           <?php endif; ?>
        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-50 w-[280px] sm:w-72 lg:w-72 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white h-screen shadow-2xl border-r border-slate-700/50 backdrop-blur-xl relative overflow-hidden transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out" style="touch-action: pan-y;">
            ...
            <div class="p-4 sm:p-6 border-b border-slate-700/50">
                <div class="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                    <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg flex-shrink-0 overflow-hidden bg-white/10 border border-white/10">
                        ...
                        ?>
                        <?php if($logoExists): ?>
                            <img src="<?php echo e(asset('build/assets/logo.png')); ?>" alt="Cutietyha POS" class="w-full h-full object-contain p-1">
                        <?php else: ?>
                ...
                <?php if(auth()->user()->branch): ?>
                    <div class="flex items-center space-x-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-slate-800/50 rounded-lg border border-slate-700/50">
                        ...
                        <span class="text-xs sm:text-sm text-slate-300 font-medium truncate"><?php echo e(auth()->user()->branch->name); ?></span>
                    </div>
                <?php endif; ?>
            ...
            <nav class="mt-6 px-2 sm:px-3 space-y-1.5 sm:space-y-2 overflow-y-auto flex-1">
                <?php if(auth()->user()->hasRole('super_admin')): ?>
                    <a href="<?php echo e(route('dashboard.super-admin')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 text-sm sm:text-base <?php echo e(request()->routeIs('dashboard.super-admin') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('dashboard.super-admin') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <span class="font-medium">Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('businesses.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 text-sm sm:text-base <?php echo e(request()->routeIs('businesses.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('businesses.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                        <span class="font-medium">Businesses</span>
                    </a>
                    <a href="<?php echo e(route('branches.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 text-sm sm:text-base <?php echo e(request()->routeIs('branches.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('branches.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
                        <span class="font-medium">Branches</span>
                    </a>
                    <a href="<?php echo e(route('admin.users')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('admin.users') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.users') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        <span class="font-medium">Users</span>
                    </a>
                    <a href="<?php echo e(route('admin.roles.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                        </svg>
                        <span class="font-medium">Roles & Permissions</span>
                    </a>
                    <a href="<?php echo e(route('settings.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('settings.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('settings.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php elseif(auth()->user()->hasRole('admin')): ?>
                    <a href="<?php echo e(route('dashboard.admin')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('dashboard.admin') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('dashboard.admin') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <span class="font-medium">Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('pos.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('pos.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('pos.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                        <span class="font-medium">POS Terminal</span>
                    </a>
                    <a href="<?php echo e(route('admin.products')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('admin.products') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.products') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                        </svg>
                        <span class="font-medium">Products</span>
                    </a>
                    <a href="<?php echo e(route('customers.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('customers.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('customers.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span class="font-medium">Customers</span>
                    </a>
                    <a href="<?php echo e(route('inventory.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('inventory.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('inventory.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                        </svg>
                        <span class="font-medium">Inventory</span>
                    </a>
                    <a href="<?php echo e(route('orders.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('orders.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('orders.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span class="font-medium">Orders</span>
                    </a>
                    <a href="<?php echo e(route('accounting.expenses')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('accounting.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('accounting.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                        </svg>
                        <span class="font-medium">Accounting</span>
                    </a>
                    <a href="<?php echo e(route('reports.sales')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('reports.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('reports.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.categories.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                        <span class="font-medium">Categories</span>
                    </a>
                    <a href="<?php echo e(route('attendance.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('attendance.*') || request()->routeIs('shifts.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('attendance.*') || request()->routeIs('shifts.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php elseif(auth()->user()->hasRole('sales')): ?>
                    <a href="<?php echo e(route('dashboard.sales')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('dashboard.sales') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('dashboard.sales') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <span class="font-medium">Dashboard</span>
                    </a>
                ...
                <?php elseif(auth()->user()->hasRole('accounting')): ?>
                    <a href="<?php echo e(route('dashboard.accounting')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('dashboard.accounting') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('dashboard.accounting') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <span class="font-medium">Dashboard</span>
                    </a>
                    ...
                    <a href="<?php echo e(route('exports.index')); ?>" class="group flex items-center px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base transition-all duration-300 <?php echo e(request()->routeIs('exports.*') ? 'bg-gradient-to-r from-brand-husk to-brand-teak text-white shadow-lg shadow-brand-husk/30 scale-[1.02]' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white hover:scale-[1.01] hover:shadow-md'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('exports.*') ? '' : 'group-hover:text-brand-husk'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="hidden lg:flex mt-auto p-3 sm:p-4 border-t border-slate-700/50 bg-slate-900/50 backdrop-blur-sm">
                <div class="flex items-center justify-between gap-2 sm:gap-3 w-full">
                    <div class="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-white truncate"><?php echo e(auth()->user()->display_name ?? auth()->user()->name); ?></p>
                            <p class="text-[10px] sm:text-xs text-slate-400 truncate"><?php echo e(auth()->user()->roles->first()->name ?? 'User'); ?></p>
                        </div>
                    </div>
        ...
        <main class="flex-1 bg-gradient-to-br from-slate-50 via-white to-slate-50 min-h-screen w-full lg:w-auto overflow-x-hidden">
            ...
            <?php if(session('success')): ?>
                <div class="fixed top-16 lg:top-4 left-4 right-4 lg:left-auto lg:right-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-3 lg:px-6 lg:py-4 rounded-xl shadow-2xl shadow-green-500/25 z-50 flex items-center space-x-3 animate-slide-in border border-green-400/20 backdrop-blur-sm max-w-sm lg:max-w-md mx-auto lg:mx-0" role="alert">
                    ...
                    <span class="font-medium text-sm lg:text-base"><?php echo e(session('success')); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php if(session('error')): ?>
                <div class="fixed top-16 lg:top-4 left-4 right-4 lg:left-auto lg:right-4 bg-gradient-to-r from-red-500 to-rose-600 text-white px-4 py-3 lg:px-6 lg:py-4 rounded-xl shadow-2xl shadow-red-500/25 z-50 flex items-center space-x-3 animate-slide-in border border-red-400/20 backdrop-blur-sm max-w-sm lg:max-w-md mx-auto lg:mx-0" role="alert">
                    ...
                    <span class="font-medium text-sm lg:text-base"><?php echo e(session('error')); ?></span>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\USER\Documents\pos\resources\views/layouts/app.blade.php ENDPATH**/ ?>