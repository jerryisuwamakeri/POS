...
<div class="min-h-screen animate-fade-in">
    ...
    <div class="mb-4 sm:mb-6 lg:mb-8">
        ...
        <p class="text-slate-600 flex items-center space-x-2 text-xs sm:text-sm">
            ...
            <span class="truncate"><?php echo e($branch->name); ?> - <?php echo e($branch->business->name); ?></span>
        </p>
    </div>

    <!-- Quick Actions -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
            <a href="<?php echo e(route('pos.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-brand-husk to-brand-teak rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 text-white shadow-md hover:shadow-lg transition-all duration-200 border-0">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-emerald-600 to-teal-600 rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 text-white shadow-md hover:shadow-lg transition-all duration-200 border-0">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    <div class="bg-white/20 rounded-lg sm:rounded-xl p-2 sm:p-3 flex-shrink-0">
                        <svg class="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.products')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 text-white shadow-md hover:shadow-lg transition-all duration-200 border-0">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    <div class="bg-white/20 rounded-lg sm:rounded-xl p-2 sm:p-3 flex-shrink-0">
                        <svg class="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('inventory.index')); ?>" class="group relative overflow-hidden bg-gradient-to-br from-amber-600 to-orange-600 rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 text-white shadow-md hover:shadow-lg transition-all duration-200 border-0">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    <div class="bg-white/20 rounded-lg sm:rounded-xl p-2 sm:p-3 flex-shrink-0">
                        <svg class="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
            ...
            <div class="card-elevated bg-gradient-to-br from-brand-husk to-brand-teak p-4 sm:p-5 lg:p-6 text-white">
                <div class="flex items-center justify-between">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 leading-none"><?php echo e($stats['today_orders']); ?></p>
            ...
            <div class="card-elevated bg-gradient-to-br from-emerald-600 to-teal-600 p-4 sm:p-5 lg:p-6 text-white">
                <div class="flex items-center justify-between">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-lg sm:text-xl lg:text-2xl font-bold mb-1 sm:mb-2 leading-none break-words overflow-hidden"><?php echo e(format_money($stats['today_revenue'])); ?></p>
            ...
            <div class="card-elevated bg-gradient-to-br from-amber-600 to-orange-600 p-4 sm:p-5 lg:p-6 text-white sm:col-span-2 lg:col-span-1">
                <div class="flex items-center justify-between">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 leading-none"><?php echo e($stats['low_stock_count']); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
            ...
            <div class="card-elevated p-4 sm:p-5 lg:p-6">
                ...
                <div class="h-48 sm:h-56 lg:h-64">
                    <canvas id="revenueChart" data-chart-data='<?php echo json_encode($chartData, 15, 512) ?>'></canvas>
                </div>
            </div>
            ...
            <div class="card-elevated p-4 sm:p-5 lg:p-6">
                ...
                <div class="h-48 sm:h-56 lg:h-64">
                    <canvas id="ordersChart" data-chart-data='<?php echo json_encode($ordersChartData, 15, 512) ?>'></canvas>
                </div>
            </div>
        </div>
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4">
                                    <div class="text-xs sm:text-sm font-bold text-slate-900 truncate max-w-[150px] sm:max-w-none"><?php echo e($inventory->product->name); ?></div>
                                    <div class="text-xs text-slate-500 font-medium truncate max-w-[150px] sm:max-w-none"><?php echo e($inventory->product->sku); ?></div>
                                </td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 whitespace-nowrap">
                                    <span class="text-xs sm:text-sm font-extrabold text-red-600"><?php echo e($inventory->qty); ?></span>
                                </td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 whitespace-nowrap text-xs sm:text-sm text-slate-600 font-medium"><?php echo e($inventory->min_threshold); ?></td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 whitespace-nowrap">
        ...
        <div class="card-elevated p-4 sm:p-5 lg:p-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:space-x-3">
                    <a href="<?php echo e(route('orders.index')); ?>" class="btn-secondary text-center text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">
                        View All Orders
                    </a>
                    <a href="<?php echo e(route('pos.index')); ?>" class="btn-primary text-center text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">
                        + New Order
                    </a>
                </div>
            </div>
                ...
                <div class="inline-block min-w-full align-middle px-4 sm:px-0">
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4">
                                    <div class="text-xs sm:text-sm font-bold text-slate-900 truncate max-w-[100px] sm:max-w-none"><?php echo e($order->reference); ?></div>
                                </td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4">
                                    <div class="text-xs sm:text-sm font-semibold text-slate-900 truncate max-w-[120px] sm:max-w-none"><?php echo e($order->customer_name ?? 'Walk-in'); ?></div>
                                    <div class="text-xs text-slate-500 font-medium truncate max-w-[120px] sm:max-w-none hidden sm:block"><?php echo e($order->user->display_name ?? $order->user->name); ?></div>
                                </td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 whitespace-nowrap">
                                    <div class="text-xs sm:text-sm font-extrabold text-slate-900"><?php echo e(format_money($order->total_amount)); ?></div>
                                </td>
                                <td class="px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 whitespace-nowrap">
                                    <span class="px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-bold rounded-full <?php echo e($order->status === 'paid' ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-yellow-100 text-yellow-700 border border-yellow-200'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\pos\resources\views/dashboards/admin.blade.php ENDPATH**/ ?>